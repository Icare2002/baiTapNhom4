...
public class Bus {
    ...
    private String status = "Same route";
    ...
    public Bus(String numberPlate, String route, String manufacturer, String status) {
    ...
    public void showInfor(){
        System.out.printf("%-15s %-12s %-12s %-14s %-18s ",this.numberPlate,this.route,this.manufacturer,this.status);
    }
